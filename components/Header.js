      ...
      <div className="bg-white">
        <header className="relative pb-24 bg-sky-800 sm:pb-32">
          ...
          <div className="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">AI powered photos distribution<br></br> events for distributions </h1>
            <p className="mt-6 text-xl text-cyan-100 max-w-3xl">
            empowering event cordinators and photographers with AI-powered distributions
